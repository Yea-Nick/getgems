...
import { MintingWalletBalanceResponse, FailedResponse, MintingMessageResponse, AddCNFTToCollectionResponse, CNFTRequest, OpenCNFTResult, UploadResponse } from "../getgems.schemas";
//

export class CNFTApiService {
